...
// Health
type OrderSvcNoParam struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *OrderSvcNoParam) Reset() {
	*x = OrderSvcNoParam{}
...
func (x *OrderSvcNoParam) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrderSvcNoParam) ProtoMessage() {}

func (x *OrderSvcNoParam) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_order_pb_order_proto_msgTypes[0]
...
// Deprecated: Use OrderSvcNoParam.ProtoReflect.Descriptor instead.
func (*OrderSvcNoParam) Descriptor() ([]byte, []int) {
	return file_pkg_order_pb_order_proto_rawDescGZIP(), []int{0}
}

type OrderSvcHealthCheckResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *OrderSvcHealthCheckResponse) Reset() {
	*x = OrderSvcHealthCheckResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *OrderSvcHealthCheckResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrderSvcHealthCheckResponse) ProtoMessage() {}

func (x *OrderSvcHealthCheckResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_order_pb_order_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OrderSvcHealthCheckResponse.ProtoReflect.Descriptor instead.
func (*OrderSvcHealthCheckResponse) Descriptor() ([]byte, []int) {
	return file_pkg_order_pb_order_proto_rawDescGZIP(), []int{1}
}

func (x *OrderSvcHealthCheckResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_pkg_order_pb_order_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0x11, 0x0a, 0x0f, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x76, 0x63, 0x4e, 0x6f, 0x50,
	0x61, 0x72, 0x61, 0x6d, 0x22, 0x37, 0x0a, 0x1b, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x76, 0x63,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x32, 0xa3, 0x01, 0x0a, 0x0c, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4b, 0x0a, 0x0b, 0x48,
	0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x16, 0x2e, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x76, 0x63, 0x4e, 0x6f, 0x50, 0x61, 0x72,
	0x61, 0x6d, 0x1a, 0x22, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x53, 0x76, 0x63, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65,
	...
	0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2f,
...
var file_pkg_order_pb_order_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_order_pb_order_proto_goTypes = []interface{}{
	(*OrderSvcNoParam)(nil),             // 0: order.OrderSvcNoParam
	(*OrderSvcHealthCheckResponse)(nil), // 1: order.OrderSvcHealthCheckResponse
...
var file_pkg_order_pb_order_proto_depIdxs = []int32{
	0, // 0: order.OrderService.HealthCheck:input_type -> order.OrderSvcNoParam
	2, // 1: order.OrderService.CreateOrder:input_type -> order.CreateOrderRequest
	1, // 2: order.OrderService.HealthCheck:output_type -> order.OrderSvcHealthCheckResponse
...
func file_pkg_order_pb_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_order_pb_order_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OrderSvcHealthCheckResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
